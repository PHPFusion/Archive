...
if (isset($_POST['cast_vote'])) {
	...
	if (dbrows($result) == "0") {
		$result = dbquery("INSERT INTO ".$db_prefix."poll_votes VALUES('', '".$userdata['user_id']."', '$voteoption', '$poll_id')");
...
<a href='".FUSION_INFUSIONS."member_poll_panel/polls_archive.php' class='side'>".$locale['108']."</a> <img src='".THEME."images/bulletb.gif'>\n";
		}
		echo "</center>\n";
	}
} else {
