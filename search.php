		...
		if ($rows != 0) {
			...
			while ($data = dbarray($result)) {
				...
				if (eregi($stext, $data['news_subject']) && eregi($stext, $data['news_news']) && eregi($stext, $data['news_extended'])) {
					...
					echo "<a href='news.php".$rstart."#".$data['news_id']."'>".$data['news_subject']."</a><br>\n";
					echo "<span class='small2'>".$locale['040']."<a href='profile.php?lookup=".$data['user_id']."'>".$data['user_name']."</a>\n";
					echo $locale['041'].showdate("longdate", $data['news_datestamp'])."</span><br>\n";
					echo "<span class='small'>".$subj_c." ".($subj_c == 1 ? "Match" : "Matches").$locale['432'].$locale['435'].", ";
					echo $text_c." ".($text_c == 1 ? "Match" : "Matches").$locale['432'].$locale['436'].", ";
					echo $text_c2." ".($text_c2 == 1 ? "Match" : "Matches").$locale['432'].$locale['437']."</span><br><br>";
					...
					echo $locale['041'].showdate("longdate", $data['news_datestamp'])."</span><br>\n";
					echo "<span class='small'>".$subj_c." ".($subj_c == 1 ? "Match" : "Matches").$locale['432'].$locale['435'].", ";
					echo $text_c." ".($text_c == 1 ? "Match" : "Matches").$locale['432'].$locale['436']."</span><br><br>";
					...
					echo $locale['041'].showdate("longdate", $data['news_datestamp'])."</span><br>\n";
					echo "<span class='small'>".$subj_c." ".($subj_c == 1 ? "Match" : "Matches").$locale['432'].$locale['435'].", ";
					echo $text_c." ".($text_c == 1 ? "Match" : "Matches").$locale['432'].$locale['437']."</span><br><br>";
					...
					echo "<span class='small2'>".$locale['040']."<a href='profile.php?lookup=".$data['user_id']."'>".$data['user_name']."</a>\n";
					echo $locale['041'].showdate("longdate", $data['news_datestamp'])."</span><br>\n";
					echo "<span class='small'>".$text_c." ".($text_c == 1 ? "Match" : "Matches").$locale['432'].$locale['436'].", ";
					echo $text_c2." ".($text_c2 == 1 ? "Match" : "Matches").$locale['432'].$locale['437']."</span><br><br>";
					...
					echo "<span class='small2'>".$locale['040']."<a href='profile.php?lookup=".$data['user_id']."'>".$data['user_name']."</a>\n";
					echo $locale['041'].showdate("longdate", $data['news_datestamp'])."</span><br>\n";
					echo "<span class='small'>".$text_c." ".($text_c == 1 ? "Match" : "Matches").$locale['432'].$locale['436']."</span><br><br>";
				} elseif (eregi($stext, $data['news_extended'])) {
					$text_c = substr_count(strtolower($data['news_extended']), strtolower($stext));
					echo "<a href='news.php?readmore=".$data['news_id']."'>".$data['news_subject']."</a><br>\n";
					echo "<span class='small2'>".$locale['040']."<a href='profile.php?lookup=".$data['user_id']."'>".$data['user_name']."</a>\n";
					echo $locale['041'].showdate("longdate", $data['news_datestamp'])."</span><br>\n";
					echo "<span class='small'>".$text_c." ".($text_c == 1 ? "Match" : "Matches").$locale['432'].$locale['437']."</span><br><br>";
				} elseif (eregi($stext, $data['news_subject'])) {
					$subj_c = substr_count(strtolower($data['news_subject']), strtolower($stext));
					echo "<a href='news.php".$rstart."#".$data['news_id']."'>".$data['news_subject']."</a><br>\n";
					echo "<span class='small2'>".$locale['040']."<a href='profile.php?lookup=".$data['user_id']."'>".$data['user_name']."</a>\n";
					echo $locale['041'].showdate("longdate", $data['news_datestamp'])."</span><br>\n";
					echo "<span class='small'>".$subj_c." ".($subj_c == 1 ? "Match" : "Matches").$locale['432'].$locale['437']."</span><br><br>";
				}
			}
		} else {
		...
		if ($rows != 0) {
			...
			while ($data = dbarray($result)) {
				...
				if (eregi($stext, $data['post_subject']) && eregi($stext, $data['post_message'])) {
					...
					echo "<a href='".FORUM."viewthread.php?".$rstart."forum_id=".$data['forum_id']."&thread_id=".$data['thread_id']."#".$data['post_id']."'>".$data['post_subject']."</a><br>\n";
					echo "<span class='small2'>".$locale['040']."<a href='profile.php?lookup=".$data['user_id']."'>".$data['user_name']."</a>\n";
					echo $locale['041'].showdate("longdate", $data['post_datestamp'])."</span><br>\n";
					echo "<span class='small'>".$subj_c." ".($subj_c == 1 ? "Match" : "Matches").$locale['432'].$locale['438'].", ";
					echo $text_c." ".($text_c == 1 ? "Match" : "Matches").$locale['432'].$locale['439']."</span><br><br>";
				} elseif (eregi($stext, $data['post_message'])) {
					$text_c = substr_count(strtolower($data['post_message']), strtolower($stext));
					echo "<a href='".FORUM."viewthread.php?".$rstart."forum_id=".$data['forum_id']."&thread_id=".$data['thread_id']."#".$data['post_id']."'>".$data['post_subject']."</a><br>\n";
					echo "<span class='small2'>".$locale['040']."<a href='profile.php?lookup=".$data['user_id']."'>".$data['user_name']."</a>\n";
					echo $locale['041'].showdate("longdate", $data['post_datestamp'])."</span><br>\n";
					echo "<span class='small'>".$text_c." ".($text_c == 1 ? "Match" : "Matches").$locale['432'].$locale['439']."</span><br><br>";
				} elseif (eregi($stext, $data['post_subject'])) {
					$subj_c = substr_count(strtolower($data['post_subject']), strtolower($stext));
					echo "<a href='".FORUM."viewthread.php?".$rstart."forum_id=".$data['forum_id']."&thread_id=".$data['thread_id']."#".$data['post_id']."'>".$data['post_subject']."</a><br>\n";
					echo "<span class='small2'>".$locale['040']."<a href='profile.php?lookup=".$data['user_id']."'>".$data['user_name']."</a>\n";
					echo $locale['041'].showdate("longdate", $data['post_datestamp'])."</span><br>\n";
					echo "<span class='small'>".$subj_c." ".($subj_c == 1 ? "Match" : "Matches").$locale['432'].$locale['438']."</span><br><br>";
				}
			}
		} else {
