...
<td align='right' class='tbl2'>".LAN_402."</td>
		...
		while ($data = dbarray($result)) {
			...
			echo "<td align='right'>".getuserlevel($data['user_level'])."</td>\n</tr>";
		}
		echo "</table>\n";
	} else {
	...
	echo "<td rowspan='2' class='tbl2'><a href='".FUSION_SELF."?sortby=all'>".LAN_404."</a></td>";
	for ($i=0;$i < 36!="";$i++) {
		echo "<td align='center' class='tbl1'><div class='small'><a href='".FUSION_SELF."?sortby=".$search[$i]."'>".$search[$i]."</a></div></td>";
		echo ($i==17 ? "<td rowspan='2' class='tbl2'><a href='".FUSION_SELF."?sortby=all'>".LAN_404."</a></td>\n</tr>\n<tr>\n" : "\n");
	}
	echo "</tr>\n</table>\n";
} else {
	echo "<center><br>\n".LAN_02."<br><br>\n</center>\n";
...
closetable();
echo "<div align='center' style='margin-top:5px;'>".makePageNav($rowstart,20,$rows,3,FUSION_SELF."?sortby=$sortby&")."\n</div>\n";
