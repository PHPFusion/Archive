...
if (isset($_POST['cancel_delete'])) fallback(FUSION_SELF."?sortby=$sortby&rowstart=$rowstart");
...
<tr>
<td class='tbl2'><b>".$locale['401']." [<a href='".FUSION_SELF."?step=add'>".$locale['402']."</a>]</b></td>
...
<td align='center' width='1%' class='tbl2' style='white-space:nowrap'><b>".$locale['404']."</b></td>
		...
		while ($data = dbarray($result)) {
			...
			echo "<tr>\n<td class='$cell_color'><a href='".FUSION_SELF."?step=view&amp;user_id=".$data['user_id']."'>".$data['user_name']."</a></td>
