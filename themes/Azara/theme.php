...
global $theme_width,$settings;
	...
	echo "<td width='100%' background='".THEME."images/logo_bg.gif' height='110'>$header_content</td>";
	echo "<td align='right'></td></tr></table>";
	// End banner code
	echo "<table width='100%' border='0' cellspacing='0' cellpadding='0'><tr>";
	echo "<td class='sub-header'><table background='".THEME."images/cellpic_nav.gif' width='100%' height='28' border='0' cellpadding='4' cellspacing='0' style='border:#8A8573 1px solid;'>";
...
$i++;
	...
	echo "<table width='100%' cellpadding='2' bgcolor='#9A978E' cellspacing='0' border='0'>";
}
...
global $theme_width,$settings,$locale;
	...
	echo "<table height='28' background='".THEME."images/cellpic_nav.gif' style='border: 1px solid #8A8573' cellSpacing='0' cellPadding='2' width='100%' border='0'>";
	echo "<tr><td width='35%' class='footer' align='left'><div align='left'>";
		if ($license == false) {
	echo "Powered by <a href='http://www.php-fusion.co.uk' target='_blank'><img src='".THEME."images/fusion.gif' alt='PHP-Fusion' title='PHP-Fusion' style='vertical-align:middle;'></a> v".$settings['version']." &copy; 2003-2005";
	}
	echo "</div></td>";
	echo "<td class='footer' width='20%'align='center'>Azara Theme by: <a target='_blank' href='http://phpfusion.org'><img src='".THEME."images/fthemes.gif' style='vertical-align:middle;'></a>";
...
global $locale;
	...
	echo "<td height='24' align='right' class='news-footer'>";
	if ($info['article_allow_comments']) $info['article_comments'].$locale['043']." · ";
