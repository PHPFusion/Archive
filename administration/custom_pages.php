...
".$locale['401']."<br><br>
".$locale['402']."<br>
<a href='".BASEDIR."viewpage.php?page_id=$page_id'>viewpage.php?page_id=$page_id</a><br><br>
<a href='custom_pages.php'>".$locale['403']."</a><br><br>
<a href='index.php'>".$locale['404']."</a><br><br>
</center>\n";
		closetable();
	} else {
		$result = dbquery("INSERT INTO ".$db_prefix."custom_pages VALUES('', '$page_title', '$page_access', '$page_content', '$comments', '$ratings')");
		$page_id = mysql_insert_id();
		if (isset($_POST['add_link'])) {
			$result = dbquery("SELECT * FROM ".$db_prefix."site_links ORDER BY link_order DESC LIMIT 1");
			$data = dbarray($result);
			$link_order = $data['link_order'] + 1;
			$result = dbquery("INSERT INTO ".$db_prefix."site_links VALUES('', '$page_title', 'viewpage.php?page_id=$page_id', '$page_access', '1', '0', '$link_order')");
		}
...
<a href='index.php'>".$locale['404']."</a><br><br>
	...
	$result = dbquery("DELETE FROM ".$db_prefix."site_links WHERE link_url='fusion_pages/index.php?page_id=$page_id'");
