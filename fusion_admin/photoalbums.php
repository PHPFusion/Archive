...
<tr><td>".LAN_408.":</td><td><input type='textbox' name='album_order' value='$album_order' maxlength='2' class='textbox' style='width: 40px;'>	<span class='small alt'>(";
	...
	if(file_exists(FUSION_PHOTOS."a".$album_id.".jpg")){
		echo "<br><br><a class='small' href='$PHP_SELF?action=deletealbumpic&album_id=$album_id'>".LAN_412."</a></td><td><img src='".FUSION_PHOTOS."a".$album_id.".jpg' border='1' alt='".LAN_418."' width='".$settings[album_image_w]."' height='".$settings[album_image_h]."'>";
	}else{
...
<td>".LAN_409."</td>
			...
			while($data=dbarray($result)){
				...
				if($rows!=1){
					if($album_order==1){
						$up_down=" <a href='$PHP_SELF?action=mdown&album_id=$album_id'><img src='".FUSION_THEME."images/down.gif' border='0' /></a>";
					}elseif($album_order<$rows){
						$up_down=" <a href='$PHP_SELF?action=mup&album_id=$album_id'><img src='".FUSION_THEME."images/up.gif' border='0' /></a>\n";
						$up_down.=" <a href='$PHP_SELF?action=mdown&album_id=$album_id'><img src='".FUSION_THEME."images/down.gif' border='0' /></a>";
					}else{
						$up_down=" <a href='$PHP_SELF?action=mup&album_id=$album_id'><img src='".FUSION_THEME."images/up.gif' border='0' /></a>";
					}
