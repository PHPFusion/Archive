...
?>";
	...
	$result = dbquery("DROP TABLE IF EXISTS ".$db_prefix."guestbook");
	$result = dbquery("CREATE TABLE ".$db_prefix."guestbook (
	...
	$result = dbquery("DROP TABLE IF EXISTS ".$db_prefix."temp");
	$result = dbquery("CREATE TABLE ".$db_prefix."temp (
	temp_datestamp INT(10) UNSIGNED NOT NULL DEFAULT '0',
	temp_num VARCHAR(32) NOT NULL DEFAULT ''
	) TYPE=MyISAM;");
	...
	user_level TINYINT(3) UNSIGNED NOT NULL DEFAULT '250',
...
if ($step == "2") {
	...
	if ($error != "") {
		...
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (1, 'AD', 'admins.gif', '".$locale['460']."', 'administrators.php', 2)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (2, 'AC', 'article_cats.gif', '".$locale['461']."', 'article_cats.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (3, 'A', 'articles.gif', '".$locale['462']."', 'articles.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (4, 'B', 'blacklist.gif', '".$locale['463']."', 'blacklist.php', 2)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (5, 'C', '', '".$locale['464']."', 'reserved', 2)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (6, 'CP', 'c-pages.gif', '".$locale['465']."', 'custom_pages.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (7, 'DB', 'db_backup.gif', '".$locale['466']."', 'db_backup.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (8, 'DC', 'dl_cats.gif', '".$locale['467']."', 'download_cats.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (9, 'D', 'dl.gif', '".$locale['468']."', 'downloads.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (10, 'FQ', 'faq.gif', '".$locale['469']."', 'faq.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (11, 'F', 'forums.gif', '".$locale['470']."', 'forums.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (12, 'IM', 'images.gif', '".$locale['471']."', 'images.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (13, 'I', 'infusions.gif', '".$locale['472']."', 'infusions.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (14, 'IP', '', '".$locale['473']."', 'reserved', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (15, 'M', 'members.gif', '".$locale['474']."', 'members.php', 2)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (16, 'N', 'news.gif', '".$locale['475']."', 'news.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (17, 'P', 'panels.gif', '".$locale['476']."', 'panels.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (18, 'PH', 'photoalbums.gif', '".$locale['477']."', 'photoalbums.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (19, 'PI', 'phpinfo.gif', '".$locale['478']."', 'phpinfo.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (20, 'PO', 'polls.gif', '".$locale['479']."', 'polls.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (21, 'S', 'shout.gif', '".$locale['480']."', 'shoutbox.php', 2)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (22, 'SL', 'site_links.gif', '".$locale['481']."', 'site_links.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (23, 'SU', 'submissions.gif', '".$locale['482']."', 'submissions.php', 2)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (24, 'U', 'upgrade.gif', '".$locale['483']."', 'upgrade.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (25, 'UG', 'user_groups.gif', '".$locale['484']."', 'user_groups.php', 2)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (26, 'WC', 'wl_cats.gif', '".$locale['485']."', 'weblink_cats.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (27, 'W', 'wl.gif', '".$locale['486']."', 'weblinks.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (28, 'S1', 'settings.gif', '".$locale['487']."', 'settings_main.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (29, 'S2', 'settings_time.gif', '".$locale['488']."', 'settings_time.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (30, 'S3', 'settings_forum.gif', '".$locale['489']."', 'settings_forum.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (31, 'S4', 'registration.gif', '".$locale['490']."', 'settings_registration.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (32, 'S5', 'photoalbums.gif', '".$locale['491']."', 'settings_photo.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (33, 'S6', 'settings_misc.gif', '".$locale['492']."', 'settings_misc.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES (34, 'S7', 'settings_pm.gif', '".$locale['493']."', 'settings_messages.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."users VALUES(
			'', '$username', md5('$password1'), '$email', '1', '', '0000-00-00', '', '', '', '', '', 'Default', '0', '',
			'', '0', '".time()."', '0', '0.0.0.0', 'A.AC.AD.B.C.CP.DB.DC.D.FQ.F.IM.I.IP.M.N.P.PH.PI.PO.S.SL.S1.S2.S3.S4.S5.S6.S7.SU.UG.U.W.WC', '', '103', '0'
		)");
		$result = dbquery(
			"INSERT INTO ".$db_prefix."settings VALUES('PHP-Fusion Powered Website', 'http://www.yourdomain.com/',
		...
		$result = dbquery("INSERT INTO ".$db_prefix."site_links VALUES('', '".$locale['505']."', 'contact.php', '0', '1', '0', '6')");
		$result = dbquery("INSERT INTO ".$db_prefix."site_links VALUES('', '".$locale['506']."', 'guestbook.php', '0', '1', '0', '7')");
		$result = dbquery("INSERT INTO ".$db_prefix."site_links VALUES('', '".$locale['507']."', 'weblinks.php', '0', '2', '0', '8')");
		...
		$result = dbquery("INSERT INTO ".$db_prefix."site_links VALUES('', '---', '---', '250', '1', '0', '11')");
