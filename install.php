...
require "fusion_core/fusion_core.php";
require "fusion_themes/Tropicano/theme.php";
...
echo "<html>
<head>
<title>PHP-Fusion v4.01</title>
<meta http-equiv='Content-Type' content='text/html; charset=iso-8859-1'>
<link rel='stylesheet' href='fusion_themes/Tropicano/styles.css' type='text/css'>
</head>
...
<tr>
<td align='center' class='full-header' style='padding:5px;'><img src='fusion_images/banner.gif'></td>
</tr>
</table>
...
<center>".LAN_471."<br><br>\n";
			...
			album_max_w smallint(3) unsigned NOT NULL default '400',
			album_max_h smallint(3) unsigned NOT NULL default '300',
...
if ($_POST['stage'] == "7") {
	...
	if ($error == "") {
		...
		$result = dbquery(
			"INSERT INTO ".$fusion_prefix."settings VALUES('PHP-Fusion Powered Website', 'http://yourdomain',
			'fusion_images/banner.gif', 'you@yourdomain', '$username', '<center>Welcome to your site</center>', '', '', 
			'<center>Copyright © 2004</center>', '".$_POST['site_language']."', 'Tropicano',
			'%d.%m.%y %H:%M', '%B %d %Y - %H:%M:%S', '0', '%d-%m-%y %H:%M',
			'B', '5', '0', '150000', '.gif,.jpg,.png,.zip,.rar,.tar',
			'80', '60', '120', '100', '1', '4', '16', '4', '12', '400', '300', '150000',
			'0', '10',
			'0', '401', '0', '')"
		);
		
		$result = dbquery("INSERT INTO ".$fusion_prefix."site_links VALUES('', '".LAN_540."', 'index.php', '0', '1')");
		$result = dbquery("INSERT INTO ".$fusion_prefix."site_links VALUES('', '".LAN_541."', 'articles.php', '0', '2')");
		$result = dbquery("INSERT INTO ".$fusion_prefix."site_links VALUES('', '".LAN_542."', 'downloads.php', '0', '3')");
		$result = dbquery("INSERT INTO ".$fusion_prefix."site_links VALUES('', '".LAN_550."', 'faq.php', '0', '4')");
		$result = dbquery("INSERT INTO ".$fusion_prefix."site_links VALUES('', '".LAN_543."', 'fusion_forum/index.php', '0', '5')");
		$result = dbquery("INSERT INTO ".$fusion_prefix."site_links VALUES('', '".LAN_544."', 'contact.php', '0', '6')");
		$result = dbquery("INSERT INTO ".$fusion_prefix."site_links VALUES('', '".LAN_548."', 'guestbook.php', '0', '7')");
		$result = dbquery("INSERT INTO ".$fusion_prefix."site_links VALUES('', '".LAN_545."', 'weblinks.php', '0', '8')");
		$result = dbquery("INSERT INTO ".$fusion_prefix."site_links VALUES('', '".LAN_551."', 'photogallery.php', '0', '9')");
		$result = dbquery("INSERT INTO ".$fusion_prefix."site_links VALUES('', '".LAN_546."', 'submit_news.php', '0', '10')");
		$result = dbquery("INSERT INTO ".$fusion_prefix."site_links VALUES('', '".LAN_549."', 'submit_article.php', '0', '11')");
		$result = dbquery("INSERT INTO ".$fusion_prefix."site_links VALUES('', '".LAN_547."', 'submit_link.php', '0', '12')");
...
<br>Powered by <a href='http://www.php-fusion.co.uk' class='foot'>PHP-Fusion</a> v4.01 © 2003-2004<br><br>
</td>
</tr>
</table>
