...
<input type=\"submit\" name=\"save_cat\" value=\"".LAN_242."\" class=\"button\"></td>
</tr>
</form>
</table>\n";
		closetable();
		...
		$i = 0;
		$access = array(LAN_265, LAN_266, LAN_267, LAN_268);
		while ($access[$i]) {
			if ($action == "edit" && $t == "forum") {
...
<tr>
<td colspan=\"2\">".LAN_264."<br>
<select name=\"forum_access\" class=\"textbox\" style=\"width:225px;\">
$access_opts</select></td>
</tr>
<tr>
<td align=\"center\" colspan=\"2\">
<input type=\"submit\" name=\"save_forum\" value=\"".LAN_269."\" class=\"button\"></td>
</tr>
</form>
</table>\n";
		closetable();
