...
define("LAN_407", "Leider ist der Benutzername  ".(isset($_POST['username']) ? $_POST['username']:"")." bereits vergeben.");
define("LAN_408", "Leider wird die Email Addresse ".(isset($_POST['email']) ? $_POST['email'] : "")." bereits benutzt.");
...
define("LAN_411", "Deine E-Mail Adresse oder Domain steht auf der Blacklist.");
// Email Message
define("LAN_450", "Hallo ".(isset($_POST['username']) ? $_POST['username']:"").",\n
Willkommen auf ".$settings['sitename'].". Hier sind Deine Zugangsdaten:\n
Mitgliedsname: ".(isset($_POST['username']) ? $_POST['username']:"")."
