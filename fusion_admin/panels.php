...
<td class='tbl1'><a href='$PHP_SELF?step=mright&panel_id=".$data['panel_id']."&order=".$data['panel_order']."'><img src='".fusion_themedir."images/right.gif' border='0'></a></td>
...
while ($data = dbarray($result)) {
	...
	echo "<tr>
<td class='tbl1'>".$data['panel_name']."</td>
<td class='tbl1'>".LAN_421."</td>
<td class='tbl2'><a href='$PHP_SELF?step=mleft&panel_id=".$data['panel_id']."&order=".$data['panel_order']."'><img src='".fusion_themedir."images/left.gif' border='0'></a></td>
<td class='tbl1'>".$data['panel_order']."$up_down</td>
<td class='tbl1'>";
	if ($data['panel_type'] == "file") { echo LAN_422; } else { echo LAN_423; }
	echo "</td>
