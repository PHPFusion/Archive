...
<span class='small'>".LAN_40.$data['user_name'].LAN_41.ucfirst(strftime($settings['longdate'], $data['article_datestamp']+($settings['timeoffset']*3600)))."</span>
<hr>
$article\n";
	}
} elseif ($type = "N") {
...
<span class='small'>".LAN_40.$data['user_name'].LAN_41.ucfirst(strftime($settings['longdate'], $data['news_datestamp']+($settings['timeoffset']*3600)))."</span>
<hr>
$news\n";
		if ($news_extended) {
			echo "<hr>
