...
echo "<table align='center' width='".$GLOBALS['theme_width']."' cellspacing='0' cellpadding='0' style='border:1px #aaa solid;'>
<tr>
<td>
...
echo "$info[6]".LAN_44." | <a href='printer.php?type=N&item_id=$info[0]'>".LAN_45."</a>
</td>
</tr>
</table>\n";
