...
if ($settings['tinymce_enabled'] == 1) {
	echo "<script type='text/javascript' src='".BASEDIR."includes/jscripts/tiny_mce/tiny_mce.js'></script>
...
function advanced() {
	...
	plugins:'table,advhr,advimage,advlink,insertdatetime,searchreplace,contextmenu',
