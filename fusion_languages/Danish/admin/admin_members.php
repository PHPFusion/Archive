...
define("LAN_440", "Brugerstatus:");
define("LAN_441", "Gem ændringer");
...
define("LAN_453", "Brugernavnet ".$_POST['user_name']." anvendes allerede.");
define("LAN_454", "Fejlagtig mailadresse.");
define("LAN_455", "Mailadressen ".$_POST['user_email']." anvendes allerede.");
...
// Update Profile Errors
define("LAN_480", "Tilføj bruger");
define("LAN_481", "Brugerkontoen er oprettet.");
define("LAN_482", "Brugerkontoen kunne ikke oprettes.");
define("LAN_453", "Brugernavnet ".$_POST['user_name']." anvendes allerede.");
define("LAN_454", "Mailadressen er forkert.");
?>
