...
<td><input type='text' name='guest_name' value='$guestbook_name' class='textbox' style='width:200px'></td>
</tr>
<tr>
<td align='right'>".LAN_402."</td>
<td><input type='text' name='guest_email' value='$guestbook_email' class='textbox' style='width:200px'></td>
</tr>
<tr>
<td align='right'>".LAN_403."</td>
<td><input type='text' name='guest_weburl' value='$guestbook_weburl' class='textbox' style='width:200px'></td>
</tr>
<tr>
<td align='right'>".LAN_404."</td>
<td><input type='text' name='guest_webtitle' value='$guestbook_webtitle' class='textbox' style='width:200px'></td>
</tr>
<tr>
<td align='right' valign='top'>".LAN_405."</td>
<td><textarea name='guest_message' rows='5' class='textbox' style='width:250px'>$guestbook_message</textarea><br><br>
...
".showdate("longdate", $data['guestbook_datestamp'])."</td>\n";
		if (iADMIN) {
			echo "<td align='right' class='small'><a href='".FUSION_SELF."?action=edit&guestbook_id=".$data['guestbook_id']."'>".LAN_421."</a> |
<a href='".FUSION_SELF."?action=delete&guestbook_id=".$data['guestbook_id']."' onClick='return DeleteMessage();'>".LAN_422."</a></td>\n";
		}
		echo "</tr>
</table>
</td>
