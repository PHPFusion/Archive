...
if (isset($_POST['save'])) {
	...
	if (isset($panel_id)) {
		...
		if ($error == "") {
			$result = dbquery("UPDATE ".$db_prefix."panels SET panel_name='$panel_name', panel_filename='$panel_filename', panel_content='$panel_content', panel_access='$panel_access' WHERE panel_id='$panel_id'");
		}
...
<a href='index.php'>".$locale['487']."</a><br><br>
		...
		if ($error == "") {
			...
			$result = dbquery("INSERT INTO ".$db_prefix."panels VALUES('', '$panel_name', '$panel_filename', '$panel_content', '$panel_side', '$neworder', '$panel_type', '$panel_access', '0')");
		}
