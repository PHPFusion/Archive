...
function dbconnect($db_host, $db_user, $db_pass, $db_name) {
	global $locale;
	mysql_connect($db_host, $db_user, $db_pass) or die("<center>".$locale['401']."</center>");
	mysql_select_db($db_name) or die("<center>".$locale['402'].$db_name."</center>");
	return true;
}
...
if ($step == "2") {
	...
	if ($error != "") {
		...
		'<center>Copyright &copy; 2005</center>', 'news.php', '$localeset', 'Milestone',
		...
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'AD', 'admins.gif', '".$locale['460']."', 'administrators.php', 2)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'AC', 'article_cats.gif', '".$locale['461']."', 'article_cats.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'A', 'articles.gif', '".$locale['462']."', 'articles.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'B', 'blacklist.gif', '".$locale['463']."', 'blacklist.php', 2)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'C', '', '".$locale['464']."', 'reserved', 2)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'CP', 'c-pages.gif', '".$locale['465']."', 'custom_pages.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'DB', 'db_backup.gif', '".$locale['466']."', 'db_backup.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'DC', 'dl_cats.gif', '".$locale['467']."', 'download_cats.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'D', 'dl.gif', '".$locale['468']."', 'downloads.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'FQ', 'faq.gif', '".$locale['469']."', 'faq.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'F', 'forums.gif', '".$locale['470']."', 'forums.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'IM', 'images.gif', '".$locale['471']."', 'images.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'I', 'infusions.gif', '".$locale['472']."', 'infusions.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'IP', '', '".$locale['473']."', 'reserved', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'M', 'members.gif', '".$locale['474']."', 'members.php', 2)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'N', 'news.gif', '".$locale['475']."', 'news.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'NC', 'news_cats.gif', '".$locale['494']."', 'news_cats.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'P', 'panels.gif', '".$locale['476']."', 'panels.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'PH', 'photoalbums.gif', '".$locale['477']."', 'photoalbums.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'PI', 'phpinfo.gif', '".$locale['478']."', 'phpinfo.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'PO', 'polls.gif', '".$locale['479']."', 'polls.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'S', 'shout.gif', '".$locale['480']."', 'shoutbox.php', 2)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'SL', 'site_links.gif', '".$locale['481']."', 'site_links.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'SU', 'submissions.gif', '".$locale['482']."', 'submissions.php', 2)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'U', 'upgrade.gif', '".$locale['483']."', 'upgrade.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'UG', 'user_groups.gif', '".$locale['484']."', 'user_groups.php', 2)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'WC', 'wl_cats.gif', '".$locale['485']."', 'weblink_cats.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'W', 'wl.gif', '".$locale['486']."', 'weblinks.php', 1)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'S1', 'settings.gif', '".$locale['487']."', 'settings_main.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'S2', 'settings_time.gif', '".$locale['488']."', 'settings_time.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'S3', 'settings_forum.gif', '".$locale['489']."', 'settings_forum.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'S4', 'registration.gif', '".$locale['490']."', 'settings_registration.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'S5', 'photoalbums.gif', '".$locale['491']."', 'settings_photo.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'S6', 'settings_misc.gif', '".$locale['492']."', 'settings_misc.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."admin VALUES ('', 'S7', 'settings_pm.gif', '".$locale['493']."', 'settings_messages.php', 3)");
		$result = dbquery("INSERT INTO ".$db_prefix."users VALUES('', '$username', md5('$password1'), '$email', '1', '', '0000-00-00', '', '', '', '', '', 'Default', '0', '', '', '0', '".time()."', '0', '0.0.0.0', 'A.AC.AD.B.C.CP.DB.DC.D.FQ.F.IM.I.IP.M.N.NC.P.PH.PI.PO.S.SL.S1.S2.S3.S4.S5.S6.S7.SU.UG.U.W.WC', '', '103', '0')");

		$result = dbquery("INSERT INTO ".$db_prefix."messages_options VALUES ('0', '0', '1', '20', '20', '20')");
	
		$result = dbquery("INSERT INTO ".$db_prefix."news_cats VALUES ('', '".$locale['540']."', 'bugs.gif')");
		$result = dbquery("INSERT INTO ".$db_prefix."news_cats VALUES ('', '".$locale['541']."', 'downloads.gif')");
		$result = dbquery("INSERT INTO ".$db_prefix."news_cats VALUES ('', '".$locale['542']."', 'games.gif')");
		$result = dbquery("INSERT INTO ".$db_prefix."news_cats VALUES ('', '".$locale['543']."', 'graphics.gif')");
		$result = dbquery("INSERT INTO ".$db_prefix."news_cats VALUES ('', '".$locale['544']."', 'hardware.gif')");
		$result = dbquery("INSERT INTO ".$db_prefix."news_cats VALUES ('', '".$locale['545']."', 'journal.gif')");
		$result = dbquery("INSERT INTO ".$db_prefix."news_cats VALUES ('', '".$locale['546']."', 'members.gif')");
		$result = dbquery("INSERT INTO ".$db_prefix."news_cats VALUES ('', '".$locale['547']."', 'mods.gif')");
		$result = dbquery("INSERT INTO ".$db_prefix."news_cats VALUES ('', '".$locale['548']."', 'movies.gif')");
		$result = dbquery("INSERT INTO ".$db_prefix."news_cats VALUES ('', '".$locale['549']."', 'network.gif')");
		$result = dbquery("INSERT INTO ".$db_prefix."news_cats VALUES ('', '".$locale['550']."', 'news.gif')");
		$result = dbquery("INSERT INTO ".$db_prefix."news_cats VALUES ('', '".$locale['551']."', 'php-fusion.gif')");
		$result = dbquery("INSERT INTO ".$db_prefix."news_cats VALUES ('', '".$locale['552']."', 'security.gif')");
		$result = dbquery("INSERT INTO ".$db_prefix."news_cats VALUES ('', '".$locale['553']."', 'software.gif')");
		$result = dbquery("INSERT INTO ".$db_prefix."news_cats VALUES ('', '".$locale['554']."', 'themes.gif')");
		$result = dbquery("INSERT INTO ".$db_prefix."news_cats VALUES ('', '".$locale['555']."', 'windows.gif')");

		$result = dbquery("INSERT INTO ".$db_prefix."panels VALUES ('', '".$locale['520']."', 'navigation_panel', '', '1', 1, 'file', '0', '1')");
		$result = dbquery("INSERT INTO ".$db_prefix."panels VALUES ('', '".$locale['521']."', 'online_users_panel', '', '1', 2, 'file', '0', '1')");
		$result = dbquery("INSERT INTO ".$db_prefix."panels VALUES ('', '".$locale['522']."', 'forum_threads_panel', '', '1', 3, 'file', '0', '0')");
		$result = dbquery("INSERT INTO ".$db_prefix."panels VALUES ('', '".$locale['523']."', 'latest_articles_panel', '', '1', 4, 'file', '0', '0')");
		$result = dbquery("INSERT INTO ".$db_prefix."panels VALUES ('', '".$locale['524']."', 'welcome_message_panel', '', '2', 1, 'file', '0', '1')");
		$result = dbquery("INSERT INTO ".$db_prefix."panels VALUES ('', '".$locale['525']."', 'forum_threads_list_panel', '', '2', 2, 'file', '0', '0')");
		$result = dbquery("INSERT INTO ".$db_prefix."panels VALUES ('', '".$locale['526']."', 'user_info_panel', '', '3', 1, 'file', '0', '1')");
		$result = dbquery("INSERT INTO ".$db_prefix."panels VALUES ('', '".$locale['527']."', 'member_poll_panel', '', '3', 2, 'file', '0', '0')");
		$result = dbquery("INSERT INTO ".$db_prefix."panels VALUES ('', '".$locale['528']."', 'shoutbox_panel', '', '3', 3, 'file', '0', '1')");
		
		$result = dbquery("INSERT INTO ".$db_prefix."site_links VALUES('', '".$locale['500']."', 'index.php', '0', '2', '0', '1')");
		$result = dbquery("INSERT INTO ".$db_prefix."site_links VALUES('', '".$locale['501']."', 'articles.php', '0', '2', '0', '2')");
		$result = dbquery("INSERT INTO ".$db_prefix."site_links VALUES('', '".$locale['502']."', 'downloads.php', '0', '2', '0', '3')");
		$result = dbquery("INSERT INTO ".$db_prefix."site_links VALUES('', '".$locale['503']."', 'faq.php', '0', '1', '0', '4')");
		$result = dbquery("INSERT INTO ".$db_prefix."site_links VALUES('', '".$locale['504']."', 'forum/index.php', '0', '2', '0', '5')");
		$result = dbquery("INSERT INTO ".$db_prefix."site_links VALUES('', '".$locale['507']."', 'weblinks.php', '0', '2', '0', '6')");
		$result = dbquery("INSERT INTO ".$db_prefix."site_links VALUES('', '".$locale['494']."', 'news_cats.php', '0', '2', '0', '7')");
		$result = dbquery("INSERT INTO ".$db_prefix."site_links VALUES('', '".$locale['505']."', 'contact.php', '0', '1', '0', '8')");
		$result = dbquery("INSERT INTO ".$db_prefix."site_links VALUES('', '".$locale['508']."', 'photogallery.php', '0', '1', '0', '9')");
		$result = dbquery("INSERT INTO ".$db_prefix."site_links VALUES('', '".$locale['509']."', 'search.php', '0', '1', '0', '10')");
		$result = dbquery("INSERT INTO ".$db_prefix."site_links VALUES('', '---', '---', '101', '1', '0', '11')");
		$result = dbquery("INSERT INTO ".$db_prefix."site_links VALUES('', '".$locale['510']."', 'submit.php?stype=l', '101', '1', '0', '12')");
		$result = dbquery("INSERT INTO ".$db_prefix."site_links VALUES('', '".$locale['511']."', 'submit.php?stype=n', '101', '1', '0', '13')");
		$result = dbquery("INSERT INTO ".$db_prefix."site_links VALUES('', '".$locale['512']."', 'submit.php?stype=a', '101', '1', '0', '14')");
