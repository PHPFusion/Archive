...
if (dbrows($result) != 0) {
	...
	if ($theme_width == "100%") echo "<td class='tbl2'><span class='small'><b>".LAN_32."</b></span></td>\n";
	echo "<td class='tbl2'><span class='small'><b>".LAN_33."</b></span></td>
<td align='center' class='tbl2'><span class='small'><b>".LAN_34."</b></span></td>
<td align='center' class='tbl2'><span class='small'><b>".LAN_35."</b></span></td>
<td align='right' class='tbl2'><span class='small'><b>".LAN_36."</b></span></td>
</tr>\n";
...
<td width='35%' class='$row_color'><span class='small'><a href='".FUSION_FORUM."viewthread.php?".$rstart."forum_id=".$data['forum_id']."&thread_id=".$data['thread_id']."#".$data2['post_id']."' title='".$data['thread_subject']."'>".trimlink($data['thread_subject'], 30)."</a></span></td>\n";
		} else {
			echo "<td width='55%' class='$row_color'><span class='small'><a href='".FUSION_FORUM."viewthread.php?".$rstart."forum_id=".$data['forum_id']."&thread_id=".$data['thread_id']."#".$data2['post_id']."' title='".$data['thread_subject']." (".$data['forum_name'].")'>".trimlink($data['thread_subject'], 30)."</a></span></td>\n";
		}
