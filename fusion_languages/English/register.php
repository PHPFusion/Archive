...
define("LAN_407", "Sorry, the user name ".$_POST['username']." is in use.");
define("LAN_408", "Sorry, the email address ".$_POST['email']." is in use.");
define("LAN_409", "An inactive account has been registered with the email address.");
define("LAN_410", "Incorrect validation code.");
// Email Message
define("LAN_450", "Hello ".$_POST['username'].",\n
