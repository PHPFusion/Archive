...
if ($_POST['stage'] == "7") {
	...
	if ($error == "") {
		...
		'', '', '', '', '0', '".time()."', '0', '3', '0')");
		$result = dbquery("INSERT INTO ".$fusion_prefix."settings VALUES('PHP-Fusion X3 Powered Website', 'http://yourdomain.co.uk',
		...
		'B', '5', '0', '150000', '.gif,.jpg,.png,.zip,.rar,.tar', '0', '0', '10', '0', '303')");
...
<br>Powered by PHP-Fusion X3 [RV3] Copyright © 2003-2004 <a href=\"http://www.digitaldominion.co.uk\" class=\"foot\">Digital Dominion</a><br><br>
</td>
</tr>
</table>
