...
if (dbrows($result) != 0) {
	while($data = dbarray($result)) {
		...
		echo "<img src='".THEME."images/bullet.gif'> <a href='".FORUM."viewthread.php?forum_id=".$data['forum_id']."&thread_id=".$data['thread_id']."' title='".$data['thread_subject']."' class='side'>$itemsubject</a><br>\n";
	}
} else {
...
if (dbrows($result) != 0) {
	...
	while($data = dbarray($result)) {
		...
		echo "<tr>\n<td class='side-small'><img src='".THEME."images/bullet.gif'> <a href='".FORUM."viewthread.php?forum_id=".$data['forum_id']."&thread_id=".$data['thread_id']."' title='".$data['thread_subject']."' class='side'>$itemsubject</a></td>
