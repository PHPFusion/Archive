...
".makePageNav($rowstart,$itemsperpage,$rows,3,"small","$PHP_SELF?forum_id=$forum_id&forum_cat=$forum_cat&")."
</div>\n";
...
<td class='forum2'>".LAN_451."</td>
<td width='100' class='forum2'>".LAN_452."</td>
<td align='center' width='50' class='forum2'>".LAN_453."</td>
<td align='center' width='50' class='forum2'>".LAN_454."</td>
<td width='120' class='forum2'>".LAN_404."</td>
</tr>\n";
	...
	if (dbrows($result) != 0) {
		while ($data = dbarray($result)) {
			...
			if ($data[thread_locked] == "y") {
				echo "<tr>\n<td align='center' width='25' class='forum2'><img src='".fusion_themedir."forum/folderlock.gif'></td>";
			} else  {
	        		if ($num > 0) {
			...
			echo "<td class='forum1'><img src='".fusion_themedir."forum/stickythread.gif'>
<a href='viewthread.php?forum_id=$forum_id&forum_cat=$forum_cat&thread_id=$data[thread_id]'>".$data[thread_subject]."</a></td>
<td class='forum2'><a href='../profile.php?lookup=$data[thread_author]'>$data[user_author]</a></td>
...
<span class='small'>".LAN_406."<a href='../profile.php?lookup=$data[thread_lastuser]'>$data[user_lastuser]</a></span></td>
	...
	if ($threadcount == 0) {
		echo "<tr>\n<td colspan='6' class='forum1'>".LAN_455."</td>\n</tr>\n";
	}
}
