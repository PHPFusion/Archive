...
global $theme_width,$settings;
	...
	echo "<table background='".THEME."images/center.gif' align='center' border='0' cellpadding='0' cellspacing='0' width='$theme_width' height='82'>";
	echo "<tr><td width='21'><img src='".THEME."images/header_left.gif' width='21' height='82'></td>";
	// Start banner code
	echo "<td width='100%'>$header_content</td>";
	// End banner code
	echo "<td width='21'><img src='".THEME."images/header_right.gif' width='21' height='82'></td></tr></table>\n";
	echo "<img src='".THEME."images/pixel.gif' height='5'>";
	echo "<table align='center' border='0' cellpadding='0' cellspacing='0' width='$theme_width' height='29'>";
	echo "<tr><td width='42'><img src='".THEME."images/nav_left.gif' width='42' height='29'></td>";
	echo "<td width='75%' background='".THEME."images/nav_center.gif'>";
...
if (dbrows($result) != 0) {
	...
	echo "<td align='right' width='25%' background='".THEME."images/nav_center.gif'>";
...
global $theme_width,$locale,$settings;
	...
	echo "<table align='center' border='0' cellpadding='0' cellspacing='0' width='$theme_width' height='29'>";
	echo "<tr><td width='42'><img src='".THEME."images/nav_left.gif' width='42' height='29'></td>";
	echo "<td align='left' width='38%' background='".THEME."images/nav_center.gif'>";

		if ($license == false) {
	echo "Powered by <a href='http://www.php-fusion.co.uk' target=_'blank'><img src='".THEME."images/fusion.gif' alt='PHP-Fusion' border='0' style='vertical-align:top;'></a> v".$settings['version']." &copy; 2003-2005";
	}
	echo "</td>";
	echo "<td align='center' width='25%' background='".THEME."images/nav_center.gif'>Fusion 6 by: <a target='_blank' href='http://phpfusion.org'><img src='".THEME."images/fthemes.gif' style='vertical-align:middle;'></a>";
	echo "</td>";
	echo "<td align='right' width='37%' background='".THEME."images/nav_center.gif'>";
