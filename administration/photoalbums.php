...
if ($action == "deletethumb") {
	...
	echo "<form name='albumform' method='post' action='$formaction' enctype='multipart/form-data'>
...
$access_opts</select>\n";
if ($action == "") echo $locale['443']."<input type='textbox' name='album_order' value='$album_order' maxlength='2' class='textbox' style='width: 40px;'>";
echo "</td>
</tr>
<tr>
...
<input type='submit' name='save_album' value='".$locale['445']."' class='button'>\n";
	if ($action) {
		...
		echo "<input type='hidden' name='album_order' value='$album_order'>\n";
	}
	echo "</td>\n</tr>\n</table>\n</form>\n";
	closetable();
}
