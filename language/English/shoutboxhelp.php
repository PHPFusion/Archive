<?php
define("LAN_200", "Shoutbox Help");
define("LAN_201", "The ".$settings[sitename]." Shoutbox allows visitors and members to post short messages. HTML is stripped
...
define("LAN_204", "".$settings[sitename]." reserves the right to remove any posts which infringe the afformentioned rules. Any
