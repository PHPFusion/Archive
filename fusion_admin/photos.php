...
if(!iADMIN){
	...
	if($error<>""){
		...
		echo"<a href='$PHP_SELF?album_id=$album_id'>".LAN_427."</a><br><br><a href='".FUSION_BASE."index.php'>".LAN_428."</a><br><br></center>\n";
		closetable();
	}else{
		header("Location:$PHP_SELF?album_id=$album_id");
	}
	...
	if(file_exists(FUSION_PHOTOS.$photo_id.".jpg")){
		echo "<br><br><a class='small' href='$PHP_SELF?action=deletephotopic&photo_id=$photo_id'>".LAN_412."</a></td><td><img src='".FUSION_PHOTOS.$photo_id.".jpg' border='1' alt='".LAN_418."'>";
	}else{
...
<td align='right'>".LAN_411."</td>
			...
			while($data=dbarray($result)){
				...
				if($rows!=1){
					if($photo_order==1){
						$up_down=" <a href='$PHP_SELF?action=mdown&album_id=$album_id&photo_id=$photo_id'><img src='".FUSION_THEME."images/down.gif' border='0' /></a>";
					}elseif($photo_order<$rows){
						$up_down=" <a href='$PHP_SELF?action=mup&album_id=$album_id&photo_id=$photo_id'><img src='".FUSION_THEME."images/up.gif' border='0' /></a>\n";
						$up_down.=" <a href='$PHP_SELF?action=mdown&album_id=$album_id&photo_id=$photo_id'><img src='".FUSION_THEME."images/down.gif' border='0' /></a>";
					}else{
						$up_down=" <a href='$PHP_SELF?action=mup&album_id=$album_id&photo_id=$photo_id'><img src='".FUSION_THEME."images/up.gif' border='0' /></a>";
					}
