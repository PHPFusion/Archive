...
if (isset($_POST['save_cat'])) {
	...
	if ($action == "edit" && $t == "cat") {
		...
		redirect(FUSION_SELF."?status=savece");
	} else {
		if ($cat_name != "") {
		...
		redirect(FUSION_SELF."?status=savecu");
	}
	...
	if ($action == "edit" && $t == "forum") {
		...
		redirect(FUSION_SELF."?status=savefe");
	} else {
		if ($forum_name != "") {
			$forum_mods = "";
		...
		redirect(FUSION_SELF."?status=savefu");
	}
	...
	redirect(FUSION_SELF."?status=savefm");
	...
	if (dbcount("(*)", "forums", "forum_cat='$forum_id'") == 0) {
		...
		redirect(FUSION_SELF."?status=delc1");
	} else {
		redirect(FUSION_SELF."?status=delc2");
	}
...
<td align='center' width='1%' class='tbl2' style='white-space:nowrap'>\n";
			if (dbrows($result) != 1) {
				...
				if ($i == 1) {
					$forum .= "<a href='".FUSION_SELF."?action=movedown&amp;order=$down&amp;forum_id=".$data['forum_id']."&amp;t=cat'><img src='".THEME."images/down.gif' alt='".$locale['490']."' title='".$locale['492']."' style='border:0px;'></a>\n";
				} elseif ($i < dbrows($result)) {
					$forum .= "<a href='".FUSION_SELF."?action=moveup&amp;order=$up&amp;forum_id=".$data['forum_id']."&amp;t=cat'><img src='".THEME."images/up.gif' alt='".$locale['489']."' title='".$locale['491']."' style='border:0px;'></a>\n";
					$forum .= "<a href='".FUSION_SELF."?action=movedown&amp;order=$down&amp;forum_id=".$data['forum_id']."&amp;t=cat'><img src='".THEME."images/down.gif' alt='".$locale['490']."' title='".$locale['492']."' style='border:0px;'></a>\n";
				} else {
					$forum .= "<a href='".FUSION_SELF."?action=moveup&amp;order=$up&amp;forum_id=".$data['forum_id']."&amp;t=cat'><img src='".THEME."images/up.gif' alt='".$locale['489']."' title='".$locale['491']."' style='border:0px;'></a>\n";
				}
			...
			$i++;
			$forum .= "</td>
<td align='center' width='1%' class='tbl2' style='white-space:nowrap'><a href='".FUSION_SELF."?action=edit&amp;forum_id=".$data['forum_id']."&amp;t=cat'>".$locale['481']."</a> -
...
<td align='center' width='1%' class='tbl1' style='white-space:nowrap'>\n";
					if (dbrows($result2) != 1) {
						...
						if ($k == 1) {
							$forum .= "<a href='".FUSION_SELF."?action=movedown&amp;order=$down&amp;forum_id=".$data2['forum_id']."&amp;t=forum&amp;cat=".$data2['forum_cat']."'><img src='".THEME."images/down.gif' alt='".$locale['490']."' title='".$locale['492']."' style='border:0px;'></a>\n";
						} elseif ($k < dbrows($result2)) {
							$forum .= "<a href='".FUSION_SELF."?action=moveup&amp;order=$up&amp;forum_id=".$data2['forum_id']."&amp;t=forum&amp;cat=".$data2['forum_cat']."'><img src='".THEME."images/up.gif' alt='".$locale['489']."' title='".$locale['491']."' style='border:0px;'></a>\n";
							$forum .= "<a href='".FUSION_SELF."?action=movedown&amp;order=$down&amp;forum_id=".$data2['forum_id']."&amp;t=forum&amp;cat=".$data2['forum_cat']."'><img src='".THEME."images/down.gif' alt='".$locale['490']."' title='".$locale['492']."' style='border:0px;'></a>\n";
						} else {
							$forum .= "<a href='".FUSION_SELF."?action=moveup&amp;order=$up&amp;forum_id=".$data2['forum_id']."&amp;t=forum&amp;cat=".$data2['forum_cat']."'><img src='".THEME."images/up.gif' alt='".$locale['489']."' title='".$locale['491']."' style='border:0px;'></a>\n";
						}
					...
					$k++;
					$forum .= "</td>
<td align='center' width='1%' class='tbl1' style='white-space:nowrap'><a href='".FUSION_SELF."?action=edit&amp;forum_id=".$data2['forum_id']."&amp;t=forum'>".$locale['481']."</a> -
<a href='".FUSION_SELF."?action=delete&amp;forum_id=".$data2['forum_id']."&amp;t=forum'>".$locale['482']."</a></td>
	...
	echo $forum;
	if ($forums_defined) echo "<tr>\n<td align='center' colspan='5' class='tbl1'>[ <a href='".FUSION_SELF."?action=refresh'>".$locale['493']."</a> ]</td>\n</tr>\n";
	echo "</table>\n";
	closetable();
}
