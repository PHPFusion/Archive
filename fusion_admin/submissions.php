...
<input type='submit' name='delete' value='".LAN_504."' class='button'>
	...
	if ($stage == "2" && $t == "a") {
		if (isset($_POST['publish'])) {
			...
			$result = dbquery("INSERT INTO ".$fusion_prefix."articles VALUES('', '$data[sub_article_cat]', '$subject', '$description', '$article', '$data[sub_article_breaks]', '0', '$userdata[user_name]', '$userdata[user_email]', '".time()."', '0')");
