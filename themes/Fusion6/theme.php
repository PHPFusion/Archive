...
global $theme_width,$locale,$settings;
	...
	echo "<td align='left' width='38%' height='29' style='background-image:url(".THEME."images/nav_center.gif)'>";
		...
		if ($license == false) {
	echo "Powered by <a href='http://www.php-fusion.co.uk' target='_blank'><img src='".THEME."images/fusion.gif' alt='PHP-Fusion' border='0' style='vertical-align:top;'></a> &copy; 2003-2005";
	}
	echo "</td>";
