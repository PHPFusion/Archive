...
<td width='25%' align='center' class='tbl2'><span class='small'><a href='settings_misc.php' title='".$locale['660']."'>".$locale['751']."</a></span></td>
...
<tr>
<td class='tbl' width='50%'>".$locale['702'].$locale['630']."<br><span class='small2'>".$locale['704']."</span></td>
<td class='tbl' width='50%'><input type='text' name='pm_sentbox' maxlength='4' class='textbox' style='width:40px;' value='".$pm_sentbox."'></td>
</tr>
<tr>
<td class='tbl' width='50%'>".$locale['703'].$locale['630']."<br><span class='small2'>".$locale['704']."</span></td>
