...
define("LAN_216", "Invalid ICQ#, please use numeric characters only");
define("LAN_217", "MSN ID does not appear to be valid");
define("LAN_218", "Yahoo ID contains invalid characters");
define("LAN_219", "Sorry, the User Name ".$_POST['username']." is in use.");
define("LAN_220", "Sorry, the Email Address ".$_POST['email']." is in use.");
// Email Message
