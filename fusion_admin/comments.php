...
<td class='small'>";
			if ($data[user_name]) {
				echo "<a href='".fusion_basedir."profile.php?lookup=".$data['comment_name']."'>".$data['user_name']."</a>";
			} else {
				echo "<span class='shoutboxname'>".$data['comment_name']."</span>";
			}
			echo "</td>\n";
			if (SuperAdmin()) echo "<td align='right' class='small'>IP: ".$data['comment_ip']."</td>\n";
			echo "</tr>
</table>
</td>
</tr>
<tr>
<td class='tbl1'>".parseubb(parsesmileys($data['comment_message']))."</td>
</tr>
<tr>
<td class='tbl2'>
<table cellpadding='0' cellspacing='0' width='100%'>
...
<td align='right' class='small'>".strftime($settings['longdate'], $data['comment_datestamp']+($settings['timeoffset']*3600))."</td>
</tr>
</table>
</td>
</tr>
