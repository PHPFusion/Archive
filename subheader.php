...
if ($settings['maintenance'] == "1" && !iSUPERADMIN) { header("Location:".FUSION_BASE."maintenance.php"); exit; }
if (iMEMBER) $result = dbquery("UPDATE ".$fusion_prefix."users SET user_lastvisit='".time()."' WHERE user_id='".$userdata['user_id']."'");
