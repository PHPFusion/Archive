...
<td class='tbl1'><span class='small'>".LAN_426."$posted</span></td>
</tr>
<tr>
...
if (isset($_POST['postnewthread'])) {
	...
	if (Member()) {
		if ($subject != "" && $message != "") {
			...
			$result = dbquery("INSERT INTO ".$fusion_prefix."threads VALUES('$forum_id', '', '$subject', '".$userdata['user_id']."', '0', '0', '".time()."', '".$userdata['user_id']."', '$sticky', 'n')");
