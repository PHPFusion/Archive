...
+---------------------------------------------+
| Database Backup coded by CrappoMan          |
...
include FUSION_LANGUAGES.FUSION_LAN."admin/admin_db-backup.php";

if (!checkrights("6")) { header("Location:../index.php"); exit; }

if (!isset($action)) $action = "";

//*** change this to where to store the backups.
$admindir=FUSION_BASE."fusion_admin";
...
<tr>
<td colspan='4' class='tbl2' align='left'>".LAN_411."</td>
</tr>
<tr>
...
<table align='center' cellspacing='0' cellpadding='0' class='tbl'>
<tr>
<td colspan='2' class='tbl2' align='left'>".LAN_430."</td>
</tr>
<tr>
<td colspan='2'><span class='alt'>".LAN_431."</span> $file</td>
</tr>
<tr>
<td colspan='2'><span class='alt'>".LAN_414."</span> $info_dbname</td>
</tr>
<tr>
<td colspan='2'><span class='alt'>".LAN_432."</span> $info_date</td>
</tr>
<tr>
<td colspan='2' class='alt'>".LAN_415."
<input class='textbox' type='text' name='restore_tblpre' value='$info_tblpref' style='width:150px'>
</td>
</tr>
<tr>
<td class='alt' valign='top'>".LAN_433."<br>
<select style='width:180px;' class='textbox' id='list_tbl' name='list_tbl[]' size='$maxrows' multiple>".$table_opt_list."</select>
<div align='center'>".LAN_435." [<a href=\"javascript:void(0)\" onclick=\"javascript:tableSelectAll()\">".LAN_436."</a>]
[<a href=\"javascript:void(0)\" onclick=\"javascript:tableSelectNone()\">".LAN_437."</a>]</div></td>
<td class='alt' valign='top'>".LAN_434."<br>
<select style='width:180px;' class='textbox' id='list_ins' name='list_ins[]' size='$maxrows' multiple>".$insert_opt_list."</select>
<div align='center'>".LAN_435." [<a href=\"javascript:void(0)\" onclick=\"javascript:populateSelectAll()\">".LAN_436."</a>]
[<a href=\"javascript:void(0)\" onclick=\"javascript:populateSelectNone()\">".LAN_437."</a>]</div></td>
</tr>
<tr>
<td colspan='2' align='center'><hr>
<input type='hidden' name='file' value='$file'>
<input class='button' type='submit' name='btn_do_restore' style='width:100px;' value='".LAN_438."'>
<input class='button' type='submit' name='btn_cancel' style='width:100px;' value='".LAN_439."'>
</td>
</tr>
</table>
</form>\n";
...
<table align='center' cellspacing='0' cellpadding='0' class='tbl'>
<tr>
<td colspan='2' class='tbl2' align='left'>".LAN_451."</td>
</tr>
<tr>
<td class='alt' align='right'>".LAN_414."</td>
<td>$dbname</td>
...
<tr>
<td colspan='2' class='tbl2' align='left'>".LAN_454."</td>
</tr>
<tr>
<td class='alt' align='right'>".LAN_431."</td>
...
<option value='.gz' selected>.sql.gz ".LAN_456."</option>
...
<tr>
<td class='tbl2'>".LAN_457."</td>
</tr>
<tr>
<td>
<select style='margin:5px 0px' class='textbox' id='tablelist' name='db_tables[]' size='17' multiple>".$table_opt_list."</select>
<div align='center'>".LAN_435." [<a href=\"javascript:void(0)\" onclick=\"javascript:backupSelectCore()\">".LAN_458."</a>]
[<a href=\"javascript:void(0)\" onclick=\"javascript:backupSelectAll()\">".LAN_436."</a>]
[<a href=\"javascript:void(0)\" onclick=\"javascript:backupSelectNone()\">".LAN_437."</a>]</div>
</td>
</tr>
</table>
</td>
...
<tr>
<td colspan='2' align='center'><hr>
<input class='button' type='submit' name='btn_create_backup' style='width:100px;' value='".LAN_459."'></td>
</tr>
</table>
</form>\n";
	closetable();
	...
	if($dh!=false){
		...
		@closedir($dh);
		if(!empty($filelist)){
			echo "<tr><td class='tbl2'>".LAN_481."</td>";
			echo "<td class='tbl2' align='center'>".LAN_482."</b></td>";
			echo "<td class='tbl2' align='right'>".LAN_483."</td>";
			echo "<td class='tbl2' align='right'>".LAN_484."</td></tr>";
			rsort($filelist);
			$i=0;
			foreach($filelist as $key=>$file){
				...
				echo "[<a href='".FUSION_SELF."?action=restore&file=$file[1]'>".LAN_486."</a>]&nbsp;";
				echo "[<a href='".FUSION_SELF."?action=info&file=$file[1]'>".LAN_487."</a>]";
				echo "</td></tr>";
				$i++;
			}
		}else{
