...
global $theme_width,$settings;
	...
	echo "<table width='$theme_width' class='bodyline' cellspacing='0' cellpadding='0' border='0'>";
	echo "<tr><td>";
	echo "<table width='100%' border='0' cellspacing='0' cellpadding='0'><tr>";
	echo "<td valign='center' width='100%' background='".THEME."images/logo_bg.gif' height='85'>";
	// Start banner code
	...
	echo "</td></tr></table>";
	echo "<table width='100%' border='0' cellspacing='0' cellpadding='0'><tr>";
	echo "<td><table width='100%' height='24' border='0' cellpadding='4' cellspacing='0'>";
...
function opensidex($title,$open="on") {
	...
	echo "<td align='right' class='panel-main4'><img onclick=\"javascript:flipBox('$title')\" name='b_$title' alt='$box_img' src='".THEME."images/panel_$box_img.gif'></td>";
	echo "<td class='panel-right4'><img src='".THEME."images/blank.gif' width='6' height='21' alt='' style='display:block'></td>";
	echo "</tr></table>";
	echo "<table width='100%' cellpadding='0' cellspacing='0'><tr>";
	echo "<td class='border-left4'><img src='".THEME."images/blank.gif' width='6' height='1' alt='' style='display:block'></td>";
