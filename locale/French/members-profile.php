...
$locale['404'] = "Montré tout";
// User Profile
$locale['420'] = "Profil Membre: ";
$locale['421'] = "Information Générale";
...
$locale['484'] = "L'adresse Email ".(isset($_POST['user_email']) ? $_POST['user_email'] : "")." est utilisée.";
$locale['485'] = "Le nouveau mots de passe ne correspondent pas.";
$locale['486'] = "Mot de passe non valide, utilisez des caractères alphanumèriques seulement.<br>
Le mot de passe doit avoir un  minimum de 6 caractères.";
$locale['487'] = "<b>Attention:</b> Exécution d'un script innatendue.";
?>
