...
<a href=\"index.php\">".LAN_203."</a><br><br>
		...
		if (isset($_POST[save_forum])) {
			if ($action == "edit" && $t == "forum") {
				...
				$result = dbquery("UPDATE ".$fusion_prefix."forums SET forum_name='$forum_name', forum_cat='$forum_cat', forum_order='$forum_order', forum_description='$forum_description' WHERE forum_id='$forum_id'");
