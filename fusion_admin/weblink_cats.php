...
<td align='right' widtb='60' class='tbl2'>".LAN_442."</td>
		...
		while ($data = dbarray($result)) {
			echo "<tr>
<td><a href='".FUSION_SELF."?step=edit&cat_id=".$data['weblink_cat_id']."'>".$data['weblink_cat_name']."</a><br>
<span class='small'>".$data['weblink_cat_description']."</span></td>
<td align='right' valign='top'><a href='".FUSION_SELF."?step=delete&cat_id=".$data['weblink_cat_id']."'>".LAN_443."</a></td>
</tr>\n";
		}
		echo "</table>\n";
	} else {
