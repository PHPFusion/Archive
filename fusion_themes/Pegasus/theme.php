...
<td class='bar-left'><img src='".FUSION_THEME."images/blank.gif' width='4' height='24' alt='' style='display:block'></td>\n";
$result = dbquery("SELECT * FROM ".FUSION_PREFIX."site_links WHERE link_visibility<='".iUSER."' AND link_position>='2' ORDER BY link_order");
if (dbrows($result) != 0) {
	echo "<td class='bar-main'>\n";
	$i = 1;
...
echo "<td align='right' class='bar-main'>".ucwords(showdate("%A, %B %d, %Y", time()))."</td>
<td class='bar-right'><img src='".FUSION_THEME."images/blank.gif' width='6' height='24' alt='' style='display:block'></td>
</tr>
</table>\n";
...
<tr>
<td class='header2'>".stripslashes($settings['footer'])."</td>
</tr>
</table>
<table cellpadding='0' cellspacing='0' width='100%'>
<tr>
<td align='center' class='header'><br>
...
<tr>
<td class='b-top-left'><img src='".FUSION_THEME."images/blank.gif' width='7' height='24' alt='' style='display:block'></td>
<td class='b-top-main'>$subject</td>
<td class='b-top-right'><img src='".FUSION_THEME."images/blank.gif' width='9' height='24' alt='' style='display:block'></td>
</tr>
</table>
...
<tr>
<td class='b-bottom-left'><img src='".FUSION_THEME."images/blank.gif' width='7' height='9' alt='' style='display:block'></td>
<td class='b-bottom-main'><img src='".FUSION_THEME."images/blank.gif' width='1' height='9' alt='' style='display:block'></td>
<td class='b-bottom-right'><img src='".FUSION_THEME."images/blank.gif' width='9' height='9' alt='' style='display:block'></td>
</tr>
</table>\n";
