...
<td><textarea name=\"signature\" rows=\"5\" class=\"textbox\" style=\"width:295px\" onselect=\"updatePos(this);\" onkeyup=\"updatePos(this);\" onclick=\"updatePos(this);\" ondblclick=\"updatePos(this);\">$data[user_sig]</textarea><br>
...
<input type=\"button\" value=\"Link\" class=\"button\" style=\"width:35px;\" onClick=\"AddText('url');\">
<input type=\"button\" value=\"Mail\" class=\"button\" style=\"width:35px;\" onClick=\"AddText('mail');\">
<input type=\"button\" value=\"Image\" class=\"button\" style=\"width:45px;\" onClick=\"AddText('img');\">
...
<input type=\"submit\" name=\"savechanges\" value=\"".LAN_242."\" class=\"button\" style=\"width: 100px;\"></div>
</td>
</tr>
</form>
</table>\n";
