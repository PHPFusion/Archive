...
<tr>
<td valign=\"top\" rowspan=\"2\" width=\"145\" class=\"forum1\">$data[user_name]<br>
...
<td class=\"forum1\"><span class=\"small\">".LAN_426.strftime($settings[forumdate], $data[post_datestamp]+($settings[timeoffset]*3600))."</span></td>
</tr>
<tr>
