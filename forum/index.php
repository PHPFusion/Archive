		...
		if (dbrows($result2) != 0) {
			while ($data2 = dbarray($result2)) {
				if (checkgroup($data2['forum_access'])) {
					...
					if ($new_posts > 0) { $fim = "<img src='".THEME."forum/foldernew.gif'>"; } else { $fim = "<img src='".THEME."forum/folder.gif'>"; }
	        			$forums .= "<tr>
...
<form name='search' method='post' action='".BASEDIR."search.php?stype=f'>
