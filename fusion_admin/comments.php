...
if ($article_list) {
	echo "<form name='articles_form' method='post' action='$PHP_SELF'>
<tr>
<td>".LAN_402."<br>
...
if ($news_list) {
	echo "<form name='news_form' method='post' action='$PHP_SELF'>
<tr>
<td>".LAN_403."<br>
...
if ($step == "edit") {
	...
	tablebreak();
	opentable(LAN_420);
	echo "<form name='inputform' method='post' action='$PHP_SELF?comment_id=$comment_id&$url'>
...
<span class='small'><a href='$PHP_SELF?step=edit&comment_id=".$data['comment_id']."&$url'>".LAN_431."</a> -
<a href='$PHP_SELF?step=delete&comment_id=".$data['comment_id']."&$url' onClick='return DeleteItem()'>".LAN_432."</a> -
