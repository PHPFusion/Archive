...
OVERVIEW
---------------------------
PHP-Fusion X3 is an all-in-one content management system (CMS) written in PHP4. It uses a mySQL database to
store all of it's content such as News, Articles, Forum Posts, Shoutbox Posts and more. PHP-Fusion X3 is
...
You may alter PHP-Fusion X3 any way you want and redistribute it, but if you do so please leave the original
