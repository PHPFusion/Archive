...
<td class='tbl1'><span class='small'><a href='".FUSION_SELF."?".(empty($prev)?"album=".$data['album_id']:"photo=".$prev)."'>".LAN_429."</a></span></td>
<td class='tbl2'><span class='small'><a href='".FUSION_SELF."?album=".$data['album_id']."'>".LAN_427."</a></span></td>
<td class='tbl1'><span class='small'><a href='".FUSION_SELF."?".(empty($next)?"album=".$data['album_id']:"photo=".$next)."'>".LAN_430."</a></span></td>
</tr>\n</table>\n</div>
...
<tr>
<td align='center' colspan='2' class='small'><br><a href='".FUSION_SELF."'>".LAN_426."</a></td>
</tr>
</table>";
	closetable();
	tablebreak();
