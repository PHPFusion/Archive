...
global $theme_width,$settings;
	...
	echo "<table background='".THEME."images/header-center.gif' border='0' cellpadding='0' cellspacing='0' width='$theme_width' height='82'>";
	...
	echo "<table align='center' border='0' cellpadding='0' cellspacing='0' width='100%' height='26'>";
