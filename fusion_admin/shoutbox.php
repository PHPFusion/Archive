...
if (!checkrights("J")) { header("Location:../index.php"); exit; }
...
<span class='small'><a href='".FUSION_SELF."?action=edit&shout_id=".$data['shout_id']."'>".LAN_441."</a> -
<a href='".FUSION_SELF."?action=delete&shout_id=".$data['shout_id']."'>".LAN_442."</a> -
