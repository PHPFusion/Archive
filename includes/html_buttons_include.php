...
function display_html($formname, $textarea, $html = true, $colors = false, $images = false, $folder = "") {
	...
	if ($html) {
		...
		$res .= "<input type='button' value='img' class='button' style='width:35px' onclick=\"addText('".$textarea."', '&lt;img src=\'".str_replace("../","",$folder)."', '\' style=\'margin:5px\' alt=\'\' align=\'left\' /&gt;', '".$formname."');\" />\n";
