...
<td align='center' width='1%' class='tbl1' style='white-space:nowrap'>\n";
			if (dbrows($result) != 1) {
				...
				if ($k == 1) {
					echo "<a href='".FUSION_SELF."?action=movedown&amp;order=$down&amp;link_id=".$data['link_id']."'><img src='".THEME."images/down.gif' alt='".$locale['441']."' title='".$locale['443']."' style='border:0px;'></a>\n";
				} elseif ($k < dbrows($result)) {
					echo "<a href='".FUSION_SELF."?action=moveup&amp;order=$up&amp;link_id=".$data['link_id']."'><img src='".THEME."images/up.gif' alt='".$locale['440']."' title='".$locale['442']."' style='border:0px;'></a>\n";
					echo "<a href='".FUSION_SELF."?action=movedown&amp;order=$down&amp;link_id=".$data['link_id']."'><img src='".THEME."images/down.gif' alt='".$locale['441']."' title='".$locale['443']."' style='border:0px;'></a>\n";
				} else {
					echo "<a href='".FUSION_SELF."?action=moveup&amp;order=$up&amp;link_id=".$data['link_id']."'><img src='".THEME."images/up.gif' alt='".$locale['440']."' title='".$locale['442']."' style='border:0px;'></a>\n";
				}
			...
			$k++;
echo "</td>
<td align='center' width='1%' class='tbl1' style='white-space:nowrap'><a href='".FUSION_SELF."?action=edit&amp;link_id=".$data['link_id']."'>".$locale['434']."</a> -
<a href='".FUSION_SELF."?action=delete&amp;link_id=".$data['link_id']."'>".$locale['435']."</a></td>
	...
	if (dbrows($result)) echo "<tr>\n<td align='center' colspan='5' class='tbl1'>[ <a href='".FUSION_SELF."?action=refresh'>".$locale['444']."</a> ]</td>\n</tr>\n";
	echo "</table>\n";
	closetable();
}
