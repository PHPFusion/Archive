...
global $theme_width,$settings,$locale;
	...
	echo "</div></td>";
	echo "<td class='footer' width='20%'align='center'>Azara Theme by: <a target='_blank' href='http://phpfusion.org'><img title='PHP-Fusion Themes' src='".THEME."images/fthemes.gif' style='vertical-align:middle;'></a>";
