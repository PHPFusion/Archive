...
<tr>
<td class='capleftbig'><img src='".FUSION_THEME."images/blank.gif' width='5' height='36' alt='' style='display:block'></td>
<td class='capmain'>$subject<br>
<span class='small'>".LAN_40."<a href='profile.php?lookup=".$info['user_id']."' class='white'>".$info['user_name']."</a>
".LAN_41.showdate("longdate", $info['news_date'])."</span></td>
<td class='caprightbig'><img src='".FUSION_THEME."images/blank.gif' width='5' height='36' alt='' style='display:block'></td>
</tr>
</table>
...
<td class='capmain'>$subject<br>
<span class='small'>".LAN_40."<a href='profile.php?lookup=".$info['user_id']."' class='white'>".$info['user_name']."</a>
".LAN_41.showdate("longdate", $info['article_date'])."</span></td>
<td class='caprightbig'><img src='".FUSION_THEME."images/blank.gif' width='5' height='36' alt='' style='display:block'></td>
</tr>
</table>
<table width='100%' cellpadding='0' cellspacing='0'>
...
echo "<table width='100%' cellpadding='0' cellspacing='0'>
<tr>
<td class='capleft'><img src='".FUSION_THEME."images/blank.gif' width='5' height='23' alt='' style='display:block'></td>
<td class='capmain'>$title</td>
<td class='capright'><img src='".FUSION_THEME."images/blank.gif' width='5' height='23' alt='' style='display:block'></td>
</tr>
</table>
<table width='100%' cellpadding='0' cellspacing='0'>
<tr>
...
echo "<table width='100%' cellpadding='0' cellspacing='0'>
<tr>
<td class='scapleft'><img src='".FUSION_THEME."images/blank.gif' width='3' height='19' alt='' style='display:block'></td>
<td class='scapmain'>$title</td>
<td class='scapright'><img src='".FUSION_THEME."images/blank.gif' width='3' height='19' alt='' style='display:block'></td>
</tr>
</table>
<table width='100%' cellpadding='0' cellspacing='0'>
<tr>
