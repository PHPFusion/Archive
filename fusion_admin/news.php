...
<a href=\"index.php\">".LAN_203."</a><br><br>
			...
			$result = dbquery("INSERT INTO ".$fusion_prefix."news VALUES('', '$subject', '$body', '$body2', '$breaks', '$userdata[user_name]', '$userdata[user_email]', '".time()."', '0', '0')");
			opentable(LAN_204);
			echo "<center><br>
".LAN_205."<br><br>
<a href=\"news.php\">".LAN_202."</a><br><br>
...
$editlist</select>
<input type=\"submit\" name=\"edit\" value=\"".LAN_209."\" class=\"button\">
<input type=\"submit\" name=\"delete\" value=\"".LAN_210."\" class=\"button\">
</center>
</form>\n";
		closetable();
		tablebreak();
...
<input type=\"checkbox\" name=\"line_breaks\" value=\"yes\"$breaks>".LAN_214."<br><br>
<input type=\"submit\" name=\"preview\" value=\"".LAN_215."\" class=\"button\">
<input type=\"submit\" name=\"save\" value=\"".LAN_216."\" class=\"button\"></td>
</tr>
</form>
</table>\n";
		closetable();
