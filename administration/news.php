...
if (isset($_POST['save'])) {
	...
	if (isset($news_id)) {
		...
		$result = dbquery("INSERT INTO ".$db_prefix."news VALUES('', '$news_subject', '$news_cat', '$body', '$body2', '$news_breaks', '".$userdata['user_id']."', '".($news_start_date != 0 ? $news_start_date : time())."', '$news_start_date', '$news_end_date', '$news_visibility', '0', '$news_comments', '$news_ratings')");
