...
echo "<table align='center' width='".$GLOBALS['theme_width']."' cellspacing='0' cellpadding='0' style='border:1px #555 solid;'>
<tr>
<td>
...
<table width='100%' cellpadding='0' cellspacing='0'>
<tr>
<td align='left' class='news-footer'>".LAN_40."<a href='profile.php?lookup=$info[1]' class='white'>$info[2]</a>".LAN_41."$info[3]</td>
...
echo "$info[6]".LAN_44." | <a href='printer.php?type=A&item_id=$info[0]'>".LAN_45."</a></td>
</tr>
</table>
</td>
</tr>
