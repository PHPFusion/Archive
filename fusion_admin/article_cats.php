...
if (!checkRights("2")) { header("Location:../index.php"); exit; }
...
<td align='right' width='60' class='tbl2'>".LAN_462."</td>
		...
		while ($data = dbarray($result)) {
			echo "<tr>
<td><a href='".FUSION_SELF."?action=edit&cat_id=$data[article_cat_id]'>".$data['article_cat_name']."</a><br>
<span class='small'>".$data['article_cat_description']."</span></td>
<td align='right' valign='top'><a href='".FUSION_SELF."?action=delete&cat_id=".$data['article_cat_id']."'>".LAN_463."</a></td>
</tr>\n";
		}
		echo "</table>\n";
	} else {
