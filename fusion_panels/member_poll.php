...
<center><input type='hidden' name='poll_id' value='".$data['poll_id']."'>\n";
		if (Member()) {
			echo "<input type='submit' name='cast_vote' value='".LAN_81."' class='button'></center>\n";
		} else {
			echo LAN_82."</center>\n";
		}
		echo "</form>\n";
...
<img src='".fusion_themedir."images/pollbar.gif' alt='".$polloption[$i]."' height='12' width='$optvotes%' class='poll'><br>
