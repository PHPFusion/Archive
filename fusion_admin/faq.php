...
<td><textarea name='faq_answer' cols='65' rows='5' class='textbox'>".phpentities(stripslashes($faq_data['faq_answer']))."</textarea></td>
</tr>
<tr>
<td></td><td>
...
<td class='tbl2' align='right' style='font-weight:normal;'><a href='$PHP_SELF?action=edit&faq_cat_id=".$data['faq_cat_id']."&t=cat'>".LAN_483."</a> -
