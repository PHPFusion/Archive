...
<tr>
<td class='forum2'><b>".LAN_460."</b></td>
<td class='forum2'><b>".LAN_461."</b></td>
<td align='center' class='forum2' width='100'><b>".LAN_462."</b></td>
<td align='right' class='forum2' width='120'><b>".LAN_463."</b></td>\n";
			while ($data = dbarray($result)) {
				...
				echo "<tr>
<td class='forum2'><a href='".fusion_basedir."fusion_forum/viewforum.php?forum_id=$data2[forum_id]&forum_cat=$data2[forum_cat]'>$data2[forum_name]</a></td>
<td class='forum1'><a href='".fusion_basedir."fusion_forum/viewthread.php?".$rowstart."forum_id=$data[forum_id]&thread_id=$data[thread_id]#$data[post_id]'>$data[post_subject]</a></td>
<td align='center' class='forum2'><a href='".fusion_basedir."profile.php?user_id=$data[post_author]'>$data[user_name]</a></td>
<td align='right' class='forum1'>".strftime($settings[forumdate], $data[post_datestamp]+($settings[timeoffset]*3600))."</td>
</tr>\n";
			}
			echo "</table>
</td>
