...
<tr>
<td align=\"center\" class=\"full-header\"><img src=\"fusion_images/fusion_install.gif\"></td>
</tr>
</table>
...
if (!$_POST['stage']) {
	...
	while ($file = readdir($handle)){
		if($file != "." && $file != ".." && $file != "/" && $file != "index.php") {
			if ($file == "English") { $sel = " selected"; } else { $sel = ""; }
...
<td align=\"right\" width=\"33%\" class=\"forum1\">";
	if (!is_writable("fusion_public/attachments")) { echo LAN_214; } else { echo LAN_215; }
	echo "</td>
</tr>
<tr>
...
<td width=\"33%\" class=\"forum2\">&nbsp</td>
<td align=\"right\" width=\"33%\" class=\"forum1\">";
	if (!is_writable("fusion_public/avatars")) { echo LAN_214; } else { echo LAN_215; }
	echo "</td>
</tr>
<tr>
...
<td width=\"33%\" class=\"forum2\">&nbsp</td>
<td align=\"right\" width=\"33%\" class=\"forum1\">";
	if (!is_writable("fusion_images")) { echo LAN_214; } else { echo LAN_215; }
	echo "</td>
</tr>
<tr>
...
<td width=\"33%\" class=\"forum2\">&nbsp</td>
<td align=\"right\" width=\"33%\" class=\"forum1\">";
	if (!is_writable("fusion_pages")) { echo LAN_214; } else { echo LAN_215; }
	echo "</td>
</tr>
<tr>
...
<td width=\"33%\" class=\"forum2\">&nbsp</td>
<td align=\"right\" width=\"33%\" class=\"forum1\">";
	if (!is_writable("fusion_config.php")) { echo LAN_214; } else { echo LAN_215; }
	echo "</td>
</tr>
</table>
</td>
...
<center>".LAN_271."<br><br>\n";
			...
			if ($result) {
				echo LAN_272.$fusion_prefix."custom_pages".LAN_273."<br>\n";
			} else {
			...
			if ($result) {
				echo LAN_272.$fusion_prefix."guestbook".LAN_273."<br>\n";
			} else {
				echo LAN_274.$fusion_prefix."guestbook<br>\n";
			}
			...
			if ($result) {
				echo LAN_272.$fusion_prefix."submitted_articles".LAN_273."<br>\n";
			} else {
				echo LAN_274.$fusion_prefix."submitted_articles<br>\n";
			}
			...
			if ($result) {
				echo LAN_272.$fusion_prefix."temp".LAN_273."<br>\n";
			} else {
				echo LAN_274.$fusion_prefix."temp<br>\n";
			}
...
if ($_POST['stage'] == "7") {
	...
	if ($error == "") {
		...
		'fusion_images/banner.gif', 'you@yourdomain.co.uk', '$username', '<center>Welcome to your site</center>', '', '', 
		'<center>Copyright © 2003</center>', '".$_POST['site_language']."', 'x3', '%d.%m.%y %H:%M', '%B %d %Y - %H:%M:%S',
		'0', '%d-%m-%y %H:%M', 'B', '5', '0', '150000', '.gif,.jpg,.png,.zip,.rar,.tar', '0', '0', '10', '0', '305')");
		...
		$result = dbquery("INSERT INTO ".$fusion_prefix."site_links VALUES('', '".LAN_343."', 'fusion_forum/index.php', '4')");
		$result = dbquery("INSERT INTO ".$fusion_prefix."site_links VALUES('', '".LAN_344."', 'contact.php', '5')");
		$result = dbquery("INSERT INTO ".$fusion_prefix."site_links VALUES('', '".LAN_348."', 'guestbook.php', '6')");
		$result = dbquery("INSERT INTO ".$fusion_prefix."site_links VALUES('', '".LAN_345."', 'weblinks.php', '7')");
		$result = dbquery("INSERT INTO ".$fusion_prefix."site_links VALUES('', '".LAN_346."', 'submit_news.php', '8')");
		$result = dbquery("INSERT INTO ".$fusion_prefix."site_links VALUES('', '".LAN_349."', 'submit_article.php', '9')");
		$result = dbquery("INSERT INTO ".$fusion_prefix."site_links VALUES('', '".LAN_347."', 'submit_link.php', '10')");
		opentable(LAN_360);
...
<br>Powered by PHP-Fusion v3.05 Copyright © 2003-2004 <a href=\"http://www.digitaldominion.co.uk\" class=\"foot\">Digital Dominion</a><br><br>
</td>
</tr>
</table>
