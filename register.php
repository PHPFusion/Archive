...
".LAN_430."
			...
			if (mail($to, $subject, $message, $headers)) {
				$result = dbquery("INSERT INTO ".$fusion_prefix."users VALUES('', '$username', md5('$password'), '$email', '$hide_email', '$location', '$icq', '$msn', '$yahoo', '$web', 'Default', '0', '', '$signature', '0', '".time()."', '0', '1', '0')");
				opentable(LAN_440);
				echo "<center><br>
".LAN_441."<br><br>
</center>\n";
