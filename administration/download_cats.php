...
<a href='index.php'>".$locale['404']."</a><br><br>
	...
	if (isset($_POST['save_cat'])) {
		...
		if (isset($step) && $step == "edit") {
			$result = dbquery("UPDATE ".$db_prefix."download_cats SET download_cat_name='$cat_name', download_cat_description='$cat_description', download_cat_access='$cat_access' WHERE download_cat_id='$cat_id'");
		} else {
			$result = dbquery("INSERT INTO ".$db_prefix."download_cats VALUES('', '$cat_name', '$cat_description', '$cat_access')");
		}
...
<td align='center' class='$cell_color'>".getgroupname($data['download_cat_access'])."</td>
<td align='right' class='$cell_color'><a href='".FUSION_SELF."?step=delete&cat_id=".$data['download_cat_id']."'>".$locale['443']."</a></td>
</tr>\n";
			$i++;
		}
		echo "</table>\n";
