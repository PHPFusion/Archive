...
if (isset($_POST['savesettings'])) {
	...
	keywords='$keywords', footer='$footer', language='$language', theme='$theme', shortdate='$shortdate', longdate='$longdate',
	timeoffset='$timeoffset', forumdate='$forumdate', forumpanels='$forumpanels', numofthreads='$numofthreads',
	attachments='$attachments', attachmax='$attachmax', attachtypes='$attachtypes', guestposts='$guestposts',
	displaypoll='$displaypoll', numofshouts='$numofshouts'");
}
...
// Check if the user has Admin Privelages
