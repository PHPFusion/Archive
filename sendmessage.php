...
<a href='$PHP_SELF'>".LAN_455."</a>.<br /><br />
		...
		if (isset($reply_id)) {
			$result2 = dbquery("SELECT * FROM ".$fusion_prefix."messages INNER JOIN ".$fusion_prefix."users ON ".$fusion_prefix."messages.message_from=".$fusion_prefix."users.user_id WHERE message_to='$userdata[user_id]' and message_id='$reply_id'");
