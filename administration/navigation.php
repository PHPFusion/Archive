...
if (iMEMBER) {
	if ($page1) echo "<img src='".THEME."images/bullet.gif' alt=''> <a href='".ADMIN."index.php?pagenum=1' class='side'>".$locale['ac01']."</a><br>\n";
	if ($page2) echo "<img src='".THEME."images/bullet.gif' alt=''> <a href='".ADMIN."index.php?pagenum=2' class='side'>".$locale['ac02']."</a><br>\n";
	if ($page3) echo "<img src='".THEME."images/bullet.gif' alt=''> <a href='".ADMIN."index.php?pagenum=3' class='side'>".$locale['ac03']."</a><br>\n";
	if ($page4) echo "<img src='".THEME."images/bullet.gif' alt=''> <a href='".ADMIN."index.php?pagenum=4' class='side'>".$locale['ac04']."</a><br>\n";
