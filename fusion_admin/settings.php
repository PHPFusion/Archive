...
if ($userdata[user_mod] > "2") {
	if (isset($_POST['savesettings'])) {
		...
		timeoffset='$timeoffset', forumpanels='$forumpanels', numofthreads='$numofthreads', attachments='$attachments',
		attachmax='$attachmax', attachtypes='$attachtypes', guestposts='$guestposts', displaypoll='$displaypoll', numofshouts='$numofshouts'");
...
<td valign=\"top\">
<input type=\"submit\" name=\"prune\" value=\"".LAN_317."\" class=\"button\">
...
<input type=\"submit\" name=\"savesettings\" value=\"".LAN_354."\" class=\"button\"></td>
</tr>
</form>
</table>\n";
	closetable();
