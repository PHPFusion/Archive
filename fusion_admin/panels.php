...
while ($data = dbarray($result)) {
	if ($numrows != 1) {
		...
		if ($i == 1) {
			$up_down = " <a href='$PHP_SELF?step=mdown&panel_id=".$data['panel_id']."&side=1&order=$down'><img src='".FUSION_THEME."images/down.gif' border='0'></a>";
		} else if ($i < $numrows) {
			$up_down = " <a href='$PHP_SELF?step=mup&panel_id=".$data['panel_id']."&side=1&order=$up'><img src='".FUSION_THEME."images/up.gif' border='0'></a>\n";
			$up_down .= " <a href='$PHP_SELF?step=mdown&panel_id=".$data['panel_id']."&side=1&order=$down'><img src='".FUSION_THEME."images/down.gif' border='0'></a>";
		} else {
			$up_down = " <a href='$PHP_SELF?step=mup&panel_id=".$data['panel_id']."&side=1&order=$up'><img src='".FUSION_THEME."images/up.gif' border='0'></a>";
		}
...
<td class='tbl1'><a href='$PHP_SELF?step=mright&panel_id=".$data['panel_id']."&order=".$data['panel_order']."'><img src='".FUSION_THEME."images/right.gif' border='0'></a></td>
<td class='tbl1'>".$data['panel_order']."$up_down</td>
<td class='tbl1'>";
	echo ($data['panel_type'] == "file" ? LAN_423 : LAN_424);
	echo "</td>
<td class='tbl1'>$levels[$panel_access]</td>
<td align='center' class='tbl1'>\n";
	if ($data['panel_filename'] != "user_info.php") {
		...
		echo "[<a href='$PHP_SELF?step=delete&panel_id=".$data['panel_id']."&side=1' onClick='return DeleteItem()'>".LAN_437."</a>]\n";
	}
echo "</td>
</tr>\n";
	$i++;
...
while ($data = dbarray($result)) {
	if ($numrows != 1) {
		...
		$down = $data['panel_order'] + 1;
		if ($i == 1) {
			$up_down = " <a href='$PHP_SELF?step=mdown&panel_id=".$data['panel_id']."&side=2&order=$down'><img src='".FUSION_THEME."images/down.gif' border='0'></a>";
		} else if ($i < $numrows) {
			$up_down = " <a href='$PHP_SELF?step=mup&panel_id=".$data['panel_id']."&side=2&order=$up'><img src='".FUSION_THEME."images/up.gif' border='0'></a>\n";
			$up_down .= " <a href='$PHP_SELF?step=mdown&panel_id=".$data['panel_id']."&side=2&order=$down'><img src='".FUSION_THEME."images/down.gif' border='0'></a>";
		} else {
			$up_down = " <a href='$PHP_SELF?step=mup&panel_id=".$data['panel_id']."&side=2&order=$up'><img src='".FUSION_THEME."images/up.gif' border='0'></a>";
		}
...
<td align='center' class='tbl1'>\n";
	if ($data['panel_filename'] != "user_info.php") {
		...
		echo "[<a href='$PHP_SELF?step=delete&panel_id=".$data['panel_id']."&side=2' onClick='return DeleteItem()'>".LAN_437."</a>]\n";
	}
echo "</td>
</tr>\n";
	$i++;
...
while ($data = dbarray($result)) {
	if ($numrows != 1) {
		...
		$down = $data['panel_order'] + 1;
		if ($i == 1) {
			$up_down = " <a href='$PHP_SELF?step=mdown&panel_id=".$data['panel_id']."&side=3&order=$down'><img src='".FUSION_THEME."images/down.gif' border='0'></a>";
		} else if ($i < $numrows) {
			$up_down = " <a href='$PHP_SELF?step=mup&panel_id=".$data['panel_id']."&side=3&order=$up'><img src='".FUSION_THEME."images/up.gif' border='0'></a>\n";
			$up_down .= " <a href='$PHP_SELF?step=mdown&panel_id=".$data['panel_id']."&side=3&order=$down'><img src='".FUSION_THEME."images/down.gif' border='0'></a>";
		} else {
			$up_down = " <a href='$PHP_SELF?step=mup&panel_id=".$data['panel_id']."&side=3&order=$up'><img src='".FUSION_THEME."images/up.gif' border='0'></a>";
		}
...
<td class='tbl2'><a href='$PHP_SELF?step=mleft&panel_id=".$data['panel_id']."&order=".$data['panel_order']."'><img src='".FUSION_THEME."images/left.gif' border='0'></a></td>
<td class='tbl1'>".$data['panel_order']."$up_down</td>
<td class='tbl1'>";
	echo ($data['panel_type'] == "file" ? LAN_423 : LAN_424);
	echo "</td>
...
<td align='center' class='tbl1'>\n";
	if ($data['panel_filename'] != "user_info.php") {
		...
		echo "[<a href='$PHP_SELF?step=delete&panel_id=".$data['panel_id']."&side=3' onClick='return DeleteItem()'>".LAN_437."</a>]\n";
	}
echo "</td>
</tr>\n";
	$i++;
