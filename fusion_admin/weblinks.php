...
if (!checkrights("N")) { header("Location:../index.php"); exit; }
...
<td width='75'><a href='".FUSION_SELF."?step=edit&weblink_cat_id=".$data['weblink_cat_id']."&weblink_id=".$data2['weblink_id']."'>".LAN_503."</a> -
<a href='".FUSION_SELF."?step=delete&weblink_cat_id=".$data['weblink_cat_id']."&weblink_id=".$data2['weblink_id']."' onClick='return DeleteItem()'>".LAN_504."</a></td>
</tr>\n";
				}
				echo "</table>
</div>
