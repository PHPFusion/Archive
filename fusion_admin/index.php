...
· <a href=\"custom_pages.php\">".LAN_158."</a><br><br>
· <a href=\"sitelinks.php\">".LAN_144."</a><br><br>
· <a href=\"polls.php\">".LAN_145."</a>
</td>
<td width=\"33%\" class=\"small\">
· <a href=\"forums.php\">".LAN_146."</a><br><br>
...
· <a href=\"shoutbox.php\">".LAN_151."</a>
</td>
<td valign=\"top\" width=\"33%\" class=\"small\">
· <a href=\"submissions.php\">".LAN_152."</a><br><br>
...
· <a href=\"news.php\">".LAN_141."</a><br><br>
· <a href=\"articles.php\">".LAN_143."</a><br><br>
· <a href=\"polls.php\">".LAN_145."</a><br><br>
...
echo "<span class=\"alt\">".LAN_174."</span> ".dbresult($result, 0)."<br>\n";
$result = dbquery("SELECT count(sublink_id) FROM ".$fusion_prefix."submitted_links");
echo "<span class=\"alt\">".LAN_175."</span> ".dbresult($result, 0)."
</td>
...
echo "<span class=\"alt\">".LAN_177."</span> ".dbresult($result, 0)."<br>\n";
$result = dbquery("SELECT count(post_id) FROM ".$fusion_prefix."posts");
echo "<span class=\"alt\">".LAN_178."</span> ".dbresult($result, 0)."
</td>
</tr>
</table>";
closetable();
