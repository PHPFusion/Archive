...
<a href=\"weblink_cats.php\">".LAN_203."</a><br><br>
...
<a href=\"index.php\">".LAN_204."</a><br><br>
		...
		if ($action == "edit") {
			...
			$cat_description = stripslashes($data[weblink_cat_description]);
			$formaction = "$PHP_SELF?action=edit&cat_id=$data[weblink_cat_id]";
			opentable(LAN_220);
		} else {
			$formaction = "$PHP_SELF";
			opentable(LAN_221);
...
<input type=\"submit\" name=\"save_cat\" value=\"".LAN_232."\" class=\"button\"></td>
</tr>
</form>
</table>\n";
		closetable();
...
<td align=\"right\" widtb=\"60\" class=\"altbg\">".LAN_242."</td>
			...
			while ($data = dbarray($result)) {
				echo "<tr>
<td><a href=\"$PHP_SELF?action=edit&cat_id=$data[weblink_cat_id]\">".stripslashes($data[weblink_cat_name])."</a><br>
<span class=\"small\">".stripslashes($data[weblink_cat_description])."</span></td>
<td align=\"right\" valign=\"top\"><a href=\"$PHP_SELF?action=delete&cat_id=$data[weblink_cat_id]\">".LAN_243."</a></td>
</tr>\n";
			}
			echo "</table>\n";
		} else {
