...
global $theme_width,$locale,$settings;
	...
	echo "</td>";
	echo "<td class='copyright' align='center' width='24%' style='background-image:url(".THEME."images/nav-center.gif)'>Milestone Theme by: <a target='_blank' href='http://phpfusion.org'><img src='".THEME."images/fthemes.gif' style='vertical-align:top;'></a>";
	echo "</td>";
