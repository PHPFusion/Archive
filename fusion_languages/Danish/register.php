...
define("LAN_407", "Beklager, men brugernavnet ".(isset($_POST['username']) ? $_POST['username'] : "")." anvendes allerede.");
define("LAN_408", "Beklager, men mailadressen ".(isset($_POST['email']) ? $_POST['email'] : "")." bruges allerede.");
...
// Email Message
define("LAN_450", "Hej ".(isset($_POST['username']) ? $_POST['username'] : "").",\n
