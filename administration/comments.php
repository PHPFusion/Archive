...
$allowed_ctypes = array("A","C","N","P");

if (!isset($ctype) || !in_array($ctype, $allowed_ctypes)) fallback("../index.php");
...
<tr>
<td align='center' class='tbl'><input type='submit' name='save_comment' value='".$locale['401']."' class='button'></td>
</tr>
</table>
</form>\n";
	closetable();
