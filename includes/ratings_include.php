...
global $settings,$locale,$userdata; $settings['rating_system']=1;
	...
	if (isset($_POST['post_rating'])) {
		if ($_POST['rating'] > 0) {
			$result = dbquery("INSERT INTO ".DB_PREFIX."ratings VALUES('', '$rating_item_id', '$rating_type', '".$userdata['user_id']."', '".$_POST['rating']."', '".time()."', '".USER_IP."')");
		}
...
<td width='250' class='$class'><img src='".THEME."images/pollbar.gif' height='12' width='".$pct_rating."%' class='poll'></td>
