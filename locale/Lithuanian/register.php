...
// Registration Errors
$locale['402'] = "Turite áraðyti vartotojo vardà, slaptaþodá, bei paðto adresà.";
...
$locale['406'] = "Jûsø paðto adresas negaliojantis.";
$locale['407'] = "Atleiskit, toks vardas ".(isset($_POST['username']) ? $_POST['username'] : "")." jau naudojamas.";
$locale['408'] = "Atleiskit toks paðto adresas ".(isset($_POST['email']) ? $_POST['email'] : "")." jau naudojamas.";
$locale['409'] = "Priregistruotas neaktyvus prisijungimas ðiuo paðto adresu.";
$locale['410'] = "Neteisingas patvirtinimo kodas.";
$locale['411'] = "Jûsø paðto adresas arba paðto domenas yra átrauktas á juodàjá sàraðà.";
// Email Message
$locale['450'] = "Sveiki ".(isset($_POST['username']) ? $_POST['username'] : "").",\n
Sveiki atvykæ á ".$settings['sitename'].". Jûsø prisijungimo duomenys:\n
...
$locale['454'] = "Jûsø registracija beveik baigta, dabar jûs gausite paðtà su prisijungimo duomenimis, bei nuoroda, kurià paspaudæ, aktyvuosite savo prisijungimà.";
$locale['455'] = "Jûsø prisijungimas patvirtintas.";
$locale['456'] = "Registracija nutraukta";
$locale['457'] = "Ávyko klaida, siunèiant paðtà, praðome susiekti su <a href='mailto:".$settings['siteemail']."'>Saito administracija</a>.";
$locale['458'] = "Registracija nutraukta dël sekanèiø prieþasèiø(ties):";
$locale['459'] = "Bandykite dar kartà!";
// Register Form
$locale['500'] = "Praðome ávesti jûsø duomenis. ";
$locale['501'] = "Patvirtinimo paðtu bus nusiøstas ðiuo paðto adresu, kurá èia nurodëte. ";
...
$locale['503'] = " Papildomà informacijà galësite pridëti, kai prisijungsite ir nueisite á panelá <b>Redaguoti profilá.</b>";
...
$locale['552'] = "Praðom ávesti paðto adresà.";
?>