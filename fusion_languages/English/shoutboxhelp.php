<?php
define("LAN_400", "Shoutbox Help");
define("LAN_401", "The ".$settings[sitename]." Shoutbox allows visitors and members to post short messages. HTML is stripped
...
· Use unnacceptable or abusive language.<br>
<br>
...
define("LAN_404", "".$settings[sitename]." reserves the right to remove any posts which infringe the afformentioned rules. Any
