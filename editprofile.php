...
<td>".LAN_414."</td>\n";
	...
	echo "<td><input type='radio' name='user_hide_email' value='1'$yes>".LAN_415."<input type='radio' name='user_hide_email' value='0'$no>".LAN_416."</td>
</tr>
<tr>
<td>".LAN_417."</td>
...
<tr>
<td>".LAN_418." <span class='small2'>(mm/dd/yyyy)</span></td>
...
<span class='small2'>".LAN_427."</span>";
	}
	echo "</td>
</tr>
<tr>
<td valign='top' class='content'>".LAN_428."</td>
...
<input type='submit' name='update_profile' value='".LAN_429."' class='button'></td>
</tr>
</table>
</form>\n";
closetable();
